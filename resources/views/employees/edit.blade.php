        ...
        <div class="container mt-4">
            <form method="post" action="{{ route('employees.update', $employee->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->employee_id }}"
                        type="text" 
                        class="form-control" 
                        name="employee_id" 
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="employment_status_id" required>
                        ...
                        @foreach($employmentStatus as $status)
                            <option value="{{ $status->id }}" {{ $employee->employment_status_id === $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="functional_group_id" required>
                        ...
                        @foreach($functionalGroups as $group)
                            <option value="{{ $group->id }}" {{ $employee->functional_group_id === $group->id ? 'selected' : '' }}>{{ $group->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="bureau_office_id" required>
                        ...
                        @foreach($bureauOffices as $office)
                            <option value="{{ $office->id }}" {{ $employee->bureau_office_id === $office->id ? 'selected' : '' }}>{{ $office->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="job_level_id" required>
                        ...
                        @foreach($jobLevels as $level)
                            <option value="{{ $level->id }}" {{ $employee->job_level_id === $level->id ? 'selected' : '' }}>{{ $level->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->immediate_supervisor }}"
                        type="text" 
                        class="form-control" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->last_review_at }}"
                        type="date" 
                        class="form-control" 
                        name="last_review_at" 
                        required>
