        ...
        <div class="container mt-4">
            <form method="post" action="{{ route('employees.update', $employee->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->employee_id_number }}"
                        type="text" 
                        class="form-control" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->employment_status }}"
                        type="text" 
                        class="form-control" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->functional_group }}"
                        type="text" 
                        class="form-control" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->bureau_office }}"
                        type="text" 
                        class="form-control" 
                        name="bureau_office" 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{ $employee->job_level }}"
                        type="text" 
                        class="form-control" 
                        name="job_level" 
