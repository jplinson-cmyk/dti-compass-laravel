        ...
        <form method="post"
            ...
            <div class="mb-4 row-space">
                ...
                <table class="table table-bordered table-hover shadow-lg bdr">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <textarea name="interests" id="interests" class="form-control" rows="3" placeholder="Interests" readonly></textarea>
                            </td>
                            <td>
                                <textarea name="values" id="values" class="form-control" rows="3" placeholder="Values" readonly></textarea>
                            </td>
                            <td>
                                <textarea name="careerGoals" id="careerGoals" class="form-control" rows="3" placeholder="Career Goals" readonly></textarea>
                            </td>
            ...
            <div class="mb-4 row-space">
                ...
                <table class="table table-bordered table-hover shadow-lg bdr">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <textarea name="strengths" id="strengths" class="form-control" rows="3" placeholder="Strengths" readonly></textarea>
                            </td>
                            <td>
                                <textarea name="developmentGaps" id="developmentGaps" class="form-control" rows="3" placeholder="Development Gaps"
                                    readonly></textarea>
                            </td>
                            <td>
                                <button type="button"
            ...
            <div class="mb-4">
                ...
                <table class="table table-bordered table-hover shadow-lg bdr">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <textarea id="careerRoadmapFocus" name="careerRoadmapFocus" class="form-control" rows="4"
                                    placeholder="Describe your Career Roadmap focus here" readonly></textarea>
                            </td>
                            <td>
                                <button type="button"
                ...
                <div class="row">
                    <div class="col col-sm-12 col-md-6 row-spacing">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <select class="form-select" name="aspirations[shortTerm][position]">
                            ...
                            <div class="col-6">
                                <select class="form-select" name="aspirations[shortTerm][bureauOffice]">
                                    <option value="" selected>Select Bureau/Office</option>
                        ...
                        <div class="mb-4 mt-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <select class="form-select" name="aspirations[mediumTerm][position]">
                                        <option value="" selected>Select Position</option>
                                        @foreach ($positions as $position)
                                            <option value="{{ $position->id }}">{{ $position->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-6">
                                    <select class="form-select" name="aspirations[mediumTerm][bureauOffice]">
                                        <option value="" selected>Select Bureau/Office</option>
                                        @foreach ($bureauOffices as $bureauOffice)
                                            <option value="{{ $bureauOffice->id }}">{{ $bureauOffice->name }}</option>
                                        @endforeach
                        ...
                        <div class="mb-4 mt-3">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <select class="form-select" name="aspirations[longTerm][position]">
                                        <option value="" selected>Select Position</option>
                                        @foreach ($positions as $position)
                                            <option value="{{ $position->id }}">{{ $position->name }}</option>
                                        @endforeach
                                ...
                                <div class="col-6">
                                    <select class="form-select" name="aspirations[longTerm][bureauOffice]">
                                        <option value="" selected>Select Bureau/Office</option>
                                        @foreach ($bureauOffices as $bureauOffice)
                                            <option value="{{ $bureauOffice->id }}">{{ $bureauOffice->name }}</option>
                                        @endforeach
                                    ...
                                    <tr>
                                        <td>
                                            <textarea name="mobilityPreferences" id="mobilityPreferences" class="form-control" rows="3"
                                                placeholder="Ex. Head Office, with little to no travel" readonly></textarea>
                                        </td>
                                        <td>
                                            <button type="button"
                                                class="btn btn-outline-default btn-sm text-white edit-action-btn mt-2 brand-color-bg"
                                    ...
                                    <tr>
                                        <td>
                                            <textarea name="mobilityConstraints" id="mobilityConstraints" class="form-control" rows="3"
                                                placeholder="Ex. My physical injury serves as a hindrance for me to traveling to different places" readonly></textarea>
                                        </td>
                                        <td>
                                            <button type="button"
                                                class="btn btn-outline-default btn-sm text-white edit-action-btn mt-2 brand-color-bg"
            ...
            <div class="mb-4">
                ...
                <div class="d-flex flex-row align-items-center ">
                    ...
                    <div class="col-3">
                        <select class="form-select" id="competencyDevelopmentGoal" readonly>
                ...
                <table class="table mt-3 table-striped shadow-lg bdr mt-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Text here</td>
                            <td><button class="btn btn-outline-default btn-sm text-white brand-color-bg"><i
            ...
            @foreach (['shortTerm', 'mediumTerm', 'longTerm'] as $term)
                @for ($i = 1; $i <= 2; $i++)
                    <div class="mb-4 row-space">
                        <h6 class="fw-bold mt-5 mb-4">{{ ucfirst($term) }} {{ $i }}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="developmentActivities[{{ $term }}][{{ $i }}][{{ $activityType }}][action]"
                                                ...
                                                rows="3" placeholder="Development Actions" readonly></textarea>
                                        </td>
                                        <td>
                                            <textarea name="developmentActivities[{{ $term }}][{{ $i }}][{{ $activityType }}][measures]"
                                                id="{{ $term }}{{ $i }}{{ $activityType }}Measures" class="form-control" rows="3"
                                                placeholder="Measures / Target Dates" readonly></textarea>
                                        </td>
                                        <td>
                                            <input type="text"
                                                name="developmentActivities[{{ $term }}][{{ $i }}][{{ $activityType }}][by_whom]"
                                                id="{{ $term }}{{ $i }}{{ $activityType }}ByWhom"
                                                class="form-control" placeholder="By whom" readonly>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <textarea
                                                ...
                                                id="{{ $term }}{{ $i }}{{ $activityType }}SupervisorNotes" class="form-control"
                                                rows="3" placeholder="Supervisor Notes" readonly></textarea>
                                        </td>
                                        <td>
                                            <button type="button"
                                                class="btn btn-outline-default btn-sm text-white edit-action-btn brand-color-bg"
            ...
            <div class="d-flex justify-content-between">
                ...
                <div>
                    <button type="submit" class="btn btn-md mt-2 text-light brand-color-bg">Save</button>
    ...
    <script>
        $(document).ready(function() {
            $('.edit-action-btn').click(function() {
                ...
                var $textareas = $(this).closest('tr').find('textarea');
                var $selects = $(this).closest('.row-spacing').find('select');

                $(this).data('editing', !isEditing);

                $icon.toggleClass('fa-edit fa-times');

                $textareas.prop('readonly', isEditing);
                $selects.prop('readonly', isEditing);

                if (!isEditing) {
                    $textareas.prop('readonly', false);
                    $selects.prop('readonly', false);
                }
            });
        });
    </script>
